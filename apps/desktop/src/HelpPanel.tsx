      ...
      },
      {
        ...
        content: (
          <div>
            ...
            <ol>
              <li>Avvia <strong>LIMEN Vault v6Mini</strong> {terms.onDeviceTerm}.</li>
      ...
      },
      {
        ...
        content: (
          <div>
            ...
            <p>
              LIMEN Vault v6Mini integra un motore di intelligenza semantica locale basato su <strong>llama-server</strong> e il modello <strong>BAAI/bge-m3</strong> quantizzato a 8 bit (<code>bge-m3-Q8_0.gguf</code>, 1024 dimensioni).
            </p>
      ...
      >
        <div style={{ position: 'relative', zIndex: 2, maxWidth: 700 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
            ...
            <span style={{ fontSize: 12, color: '#94a3b8' }}>v6Mini · RAG Locale bge-m3 & Ricerca Ibrida BM25</span>
          </div>

          <h2 style={{ fontSize: 24, fontWeight: 800, margin: '0 0 8px 0', letterSpacing: '-0.02em' }}>
            Guida & Manuale Utente LIMEN Vault v6Mini
          </h2>
