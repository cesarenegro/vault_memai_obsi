...
const messages: Record<string,string> = {
  ...
  'Keychain access denied or unavailable':'Accesso al Portachiavi negato o non disponibile.',
  'Unable to remove Keychain entry':'Impossibile rimuovere la chiave dal Portachiavi.',
  ...
  'Tunnel Keychain access denied':'Accesso alla chiave del tunnel nel Portachiavi negato.',
